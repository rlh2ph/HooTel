    ...
    <section id="contact">
      <div class="container">
        ...
        <div class="row">
            ...
            <i class="fa fa-2x fa-phone sr-icons"></i>
            <p class="iconspace" >
              <a>703-638-3227</a>
            </p>
          </div>
					<div class="col-lg-4 mr-auto text-center">
            <i class="fa fa-2x fa-home sr-icons"></i>
            <p class="iconspace" >
              <a>1308 Wertland St. Charlottesville VA, 22903</a>
            </p>
          </div>
          <div class="col-lg-4 mr-auto text-center">
            <i class="fa fa-envelope-o fa-2x sr-contact"></i>
            <p class="iconspace" >
              <a href="mailto:amb6sg@virginia.edu">amb6sg@virginia.edu</a>
            </p>
          </div>
        </div>
      </div>
