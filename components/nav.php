...
<nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
    <div class="container">
		<a class="navbar-brand js-scroll-trigger" href="/THEHOOTEL">
			The HooTel
		</a>
		...
		<div class="collapse navbar-collapse" id="navbarResponsive">
			<ul class="navbar-nav ml-auto">
				...
				<li class="nav-item">
					<a class="btn-solid-color nav-link js-scroll-trigger" href="payment.php"><span class="nav-margin-10px btn-padding-20 btn-lookalike">Payment</span></a>
				</li>
			</ul>
		</div>
	</div>
